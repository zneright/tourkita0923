...
export default function MapsScreen() {
    ...
    // 👇 Handle navigation params from EventDetailModal
    useEffect(() => {
        if (route.params) {
            const { category, latitude, longitude } = route.params as any;

            // ✅ Automatically filter to "Events" when navigated from EventDetailModal
            if (category) {
                setSelectedCategory(category);
            }

            // ✅ If coordinates are passed, center the camera on the event
