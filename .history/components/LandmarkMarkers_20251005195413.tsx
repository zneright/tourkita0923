        ...
        try {
            ...
            if (selectedCategory === "Events") {
                ...
                for (const docSnap of snapshot.docs) {
                    ...
                    // ✅ Show event if it happens this month
                    const inThisMonth =
                    ...
                    // --- Auto-fetch coordinates from linked marker if missing ---
...
// ✅ Update getIconKey to show today’s events differently
const getIconKey = (landmark: any) => {
    if (selectedCategory === "Events" || landmark.category === "Event") {
        return landmark.isToday ? "eventToday" : "event";
    }
            ...
            try {
                ...
                if (selectedCategory === "Events") {
                    ...
                    for (const docSnap of snapshot.docs) {
                        ...
                        // ✅ ONCE EVENTS: Show if they happen this week (Mon–Sun)
                        if (freq === "once") {
                            const inThisWeek =
                                isWithinInterval(startDate, { start: monday, end: sunday }) ||
                                (endDate && isWithinInterval(endDate, { start: monday, end: sunday }));
                            if (inThisWeek) showEvent = true;
                        }

                        // ✅ WEEKLY EVENTS: Show if recurrence overlaps this week
                        if (freq === "weekly") {
                            ...
                            // Only include if one of its recurrence days happens this week
