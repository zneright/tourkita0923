...
const EventListModal: React.FC<EventListModalProps> = ({
    ...
    const renderItem = ({ item }: { item: any }) => {
        ...
        const startTime = format(startDateISO, "h:mm a"); // e.g., 8:00 AM
        const endTime = endDateISO ? format(endDateISO, "h:mm a") : "";
        ...
        >
            <SafeAreaView style={styles.overlay}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.sectionTitle}>Upcoming Events This Month</Text>
