            ...
            try {
                ...
                if (selectedCategory === "Events") {
                    ...
                    for (const docSnap of snapshot.docs) {
                        ...
                        // ✅ Try to read start and end dates (supporting both ISO strings or Firestore timestamps)
                        const start =
                            data.dateStart
                        ...
                        if (!isOngoing) continue; // skip past/future events

                        let lat = data.lat;
                        let lng = data.lng;

                        // Fallback to linked marker if locationId exists
